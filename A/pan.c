...
short src_ln1 [] = {
	  0,  32,  33,  36,  36,  37,  40,  41, 
	 42,  43,  44,  45,  46,  34,  48,  48, 
	 31,  50,  31,  50,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "exercise_a.pml", 1, 19 },
...
short src_ln0 [] = {
	  0,  16,  17,  18,  20,  20,  21,  22, 
	 24,  24,  25,  19,  27,  15,  28,  15, 
	 28,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "exercise_a.pml", 1, 16 },
...
iniglobals(int calling_pid)
{
	...
	{	int l_in;
		...
		logval("end", now.end);
		logval("customers", now.customers);
...
{	/* int i; */
	...
	case 1:
		...
		break;
	case 0:
		printf("local vars proc %d (Barber):\n", pid);
		break;
	}
}
void
printm(int x, char *s)
{
	...
	switch (x) {
	case 1: Printf("unattended"); return;
	case 2: Printf("done"); return;
